"""
Qwen Intelligent Judge
Using Qwen to intelligently analyze whether AI responses really have security issues
"""
import os
import json
import re
...
"""
        ...
        try:
            ...
            print(f"Qwen judgment failed: {e}")
            # 返回默认安全结果
            return {
                "attack_success": False,
                "confidence": 0.0,
                "reasoning": f"Qwen call failed: {e}",
                "evaluation_details": {}
            }
